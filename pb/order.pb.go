...
var file_pb_order_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x32, 0x90, 0x02, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x29, 0x0a, 0x07, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e,
...
var file_pb_order_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_pb_order_proto_goTypes = []interface{}{
	...
	(*Empty)(nil),                 // 13: Empty
	(*OperationResponse)(nil),     // 14: OperationResponse
}
var file_pb_order_proto_depIdxs = []int32{
	...
	4,  // 9: OrderService.Create:input_type -> OrderCreateRequest
	5,  // 10: OrderService.ChangeStatus:input_type -> OrderChangeStatus
	6,  // 11: OrderService.FindOne:input_type -> OrderFindOneRequest
	7,  // 12: OrderService.FindAll:input_type -> OrderFindAllRequest
	10, // 13: OrderService.SumIncome:input_type -> OrderSumIncomeRequest
	13, // 14: OrderService.Create:output_type -> Empty
	14, // 15: OrderService.ChangeStatus:output_type -> OperationResponse
	0,  // 16: OrderService.FindOne:output_type -> Order
	9,  // 17: OrderService.FindAll:output_type -> OrderFindAllResponse
	12, // 18: OrderService.SumIncome:output_type -> OrderSumResponse
